...
t=w.create_text(50, 100, text="2 + 2 = 4", font="Courier 40 italic", fill="#ffc", anchor='nw')
t2=w.create_text(600, 20, text="Reinis Prockans", font="Courier 40 italic", fill="#ffc", anchor='ne')
