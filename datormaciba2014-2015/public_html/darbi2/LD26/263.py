...
def avots (w, apzimejums , h, xy ):
    ...
    w.create_oval (xy[0]-40 , xy[1]+h/2-40, xy[0]-120 , xy[1]+h/2+40 , width ="3", outline ='#0FF')
    w.create_line (xy[0]-80 , xy[1], xy[0]-80 , xy[1]+h ,width ="3", fill="#0FF")
    # Horizontaalu vadu grafika
    w.create_line (xy[0]-80 , xy[1],xy[0], xy[1] ,width ="3", fill="#0FF")
    w.create_line (xy[0]-80 , xy[1]+h,xy[0] , xy[1]+h,width ="3",fill="#0FF")

    # Sprieguma avota spailju simbolu grafika :
    w.create_text (xy[0]-70 , xy[1]+h/2-50 , text='+' ,fill="#FFF", font=" Courier 20 bold")
    w.create_text (xy[0]-70 , xy[1]+h/2+50 , text='-' ,fill="#FFF", font=" Courier 20 bold")
...
def vektors (w, apzimejums, h, xy ):
    ...
    w.create_text (xy[0]+ 20, xy[1]+h/2, text='U1 ',fill="#FFF", font=" Courier 20")
def fun ():
...
b = tk.Button (root , text="Dzest", command =fun3)
b.pack(side="left")
